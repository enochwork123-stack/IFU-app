  ...
  const navItems: readonly BottomNavItem[] = [
    ...
    },
    {
      ...
      activeExactPaths: [
        ...
        ROUTE_REGISTRY.FORGIVENESS_ASSURANCE,
        ROUTE_REGISTRY.VICTORY_ASSURANCE,
        ROUTE_REGISTRY.BIBLE_AUTHORITY,
        ROUTE_REGISTRY.BIBLE_INTAKE,
        ROUTE_REGISTRY.EFFECTIVE_PRAYER,
        ROUTE_REGISTRY.FELLOWSHIP,
        ROUTE_REGISTRY.WITNESSING,
        ROUTE_REGISTRY.LIFE_GOAL,
        ROUTE_REGISTRY.SPIRITUAL_GROWTH,
      ],
      activeSectionPaths: [
        ROUTE_REGISTRY.SALVATION_ASSURANCE,
        ROUTE_REGISTRY.QUIET_TIME,
