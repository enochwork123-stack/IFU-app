...
export function ProblemScreen() {
  ...
  return (
    <>
      <PageHeader title={t("人的問題")} backTo="/journey/creation" />
      ...
      <main className="gradient-descent px-6 pb-36 pt-0">
        <section className="relative flex min-h-[30rem] flex-col items-center justify-start px-2 pt-14 text-center">
          <div>
            ...
            <h2 className="font-headline text-[2.55rem] tracking-tight text-primary">
              {tContent(customScreenTexts, 'problem:hero-title') || t('失落的光輝')}
            </h2>
            <p className="mx-auto mt-4 max-w-[18rem] text-lg leading-8 text-on-surface-variant">
              {tContent(customScreenTexts, 'problem:hero-desc') || t('在造物主最初的計畫中，人本是尊貴的，直到黑暗遮蔽了視線。')}
            </p>
          </div>
        ...
        <section className="pb-12">
          <article className="rounded-[2rem] bg-white/62 p-8 shadow-[0_18px_46px_rgba(40,53,28,0.08)] backdrop-blur-xl">
            ...
            <p className="mt-4 leading-7 text-on-surface-variant">
              {t("聖經指出人人人犯了罪，就是在思想和行為上違背神，偏離了祂良善的標準。")}
            </p>
            <ScriptureCard
              reference={t("羅馬書 3:23")}
              verse={t("因為世人都犯了罪，虧缺了神的榮耀。")}
              className="mt-8"
            />
          </article>
        </section>
          ...
          <div className="space-y-8 text-center">
            ...
            <div>
              <h3 className="font-headline text-[1.9rem] text-primary">
                {tContent(customScreenTexts, 'problem:chasm-title') || t('人的罪使人與神分隔')}
              </h3>
              <p className="mt-3 leading-7 text-on-surface-variant">
                {tContent(customScreenTexts, 'problem:chasm-desc') || t('罪惡就像一道無法逾越的鴻溝，攔阻了我們尋求神，也掩蓋了祂對我們的祝福。')}
              </p>
            </div>

            <ScriptureCard
              reference={t("以賽亞書 59:2")}
              verse={t("但你們的罪孽使你們與神隔絕；你們的罪惡使他掩面不聽你們。")}
            />
          </div>
        </section>
        ...
        <section className="rounded-t-[2.5rem] bg-primary px-6 py-14 text-surface">
          <div className="text-center">
            ...
            <h3 className="font-headline text-[1.9rem]">
              {tContent(customScreenTexts, 'problem:gavel-title') || t('罪的工價就是死')}
            </h3>
            <p className="mt-4 leading-7 text-surface/72">
              {tContent(customScreenTexts, 'problem:gavel-desc') || t('罪不僅破壞了現世的生命，更帶來了終極的結局。死後，每個人都必須面對造物主公義的審判。')}
            </p>
          </div>
          <div className="mt-10 grid gap-5">
            <ScriptureCard
              reference={t("羅馬書 6:23")}
              verse={t("因為罪的工價乃是死；惟有神的恩賜，在我們的主基督耶穌裡，乃是永生。")}
              tone="dark"
              accent="soft"
            />
            <ScriptureCard
              reference={t("希伯來書 9:27")}
              verse={t("按著定命，人人人有一死，死後且有審判。")}
              tone="dark"
              accent="soft"
            />
          </div>
        ...
        <section className="rounded-b-[2.5rem] bg-[#171815] px-6 py-16 text-center text-surface">
          <div className="relative">
            ...
            <div className="relative">
              ...
              <h3 className="font-headline text-[2.2rem] tracking-[0.18em]">
                {tContent(customScreenTexts, 'problem:chasm-death-title') || t('永遠沉淪')}
              </h3>
            </div>
          </div>

          <ScriptureCard
            reference={t("帖撒羅尼迦後書 1:8-9")}
            verse={t("要報應那不認識神和那不聽從我主耶穌福音的人。")}
            tone="dark"
            accent="soft"
          ...
          <h4 className="mt-10 font-headline text-[1.8rem]">
            {tContent(customScreenTexts, 'problem:chasm-death-rescue') || t('無法自救的絕路')}
          </h4>
          <p className="mt-4 leading-7 text-surface/62">
            {tContent(customScreenTexts, 'problem:chasm-death-desc') || t('無論人如何努力，行善、道德或宗教，都無法洗淨靈魂的污點，脫離這必然的結局。')}
          </p>
        </section>
        ...
        <section className="bg-[linear-gradient(180deg,_#171815_0%,_#fbf9f5_100%)] px-2 py-14 text-center">
          ...
          <p className="mt-6 font-headline text-[1.9rem] leading-tight text-primary">
            {tContent(customScreenTexts, 'problem:footer-title') || t('縱然人違背了神，神仍是愛人的。')}
          </p>
          <p className="mt-5 leading-7 text-on-surface-variant">
            {tContent(customScreenTexts, 'problem:footer-desc') || t('在黑暗的盡頭，祂為我們預備了一條出路。祂不願一人沉淪，乃願萬人悔改，重新回到祂的懷抱。')}
          </p>
          <Link
            to="/journey/bridge"
        ...
        <JourneyPager
          previous={{ to: '/journey/creation', label: t('神的創造') }}
          next={{ to: '/journey/bridge', label: t('神的拯救') }}
        />
      </main>
    </>
  );
