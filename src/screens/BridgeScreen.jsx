...
export function BridgeScreen() {
  ...
  return (
    <>
      <PageHeader title={t("神的拯救")} backTo="/journey/problem" />
      ...
      <main className="px-6 pb-36 pt-8">
        ...
        <section className="mt-8 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-headline text-[1.8rem] text-primary">{t("唯一的橋樑")}</h3>
          </div>
          <div className="rounded-[2rem] bg-surface-container-lowest p-6 shadow-[0_18px_42px_rgba(40,53,28,0.08)]">
            <p className="text-[1.05rem] leading-8 text-on-surface">
              {t("然而神與人之間的鴻溝極大，只有神所預備的唯一橋樑才能跨越，把人救贖。")}
            </p>
            <p className="mt-4 text-[1.05rem] leading-8 text-on-surface">
              {t("神救贖人的計劃是：祂親自以人的身份來到世上，稱為神的兒子耶穌基督，為我們的罪被釘死在十字架上，三日後復活。")}
            </p>
            <ScriptureCard
              reference={t("彼得前書 3:18")}
              verse={t("基督也曾一次為罪受苦，就是義的代替不義的，為要引我們到神面前。")}
              className="mt-6"
            />
          </div>
        </section>
        ...
        <section className="relative mt-10 overflow-hidden rounded-[2.4rem] bg-primary p-8 text-white shadow-[0_28px_72px_rgba(40,53,28,0.22)]">
          ...
          <div className="relative">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-headline text-[2rem]">{t("耶穌的救贖")}</h3>
            </div>
            <p className="mt-5 text-[1.08rem] leading-8 text-on-primary-container">
              {t("耶穌以死來替我們擔負罪的刑罰。祂的復活顯明祂是神，而且戰勝了死亡和罪惡。")}
            </p>
            <ScriptureCard
              reference={t("哥林多前書 15:3-6")}
              verse={t("基督照聖經所說，為我們的罪死了，而且埋葬了，又照聖經所說，第三天復活了。")}
              tone="dark"
              accent="soft"
        ...
        <section className="mt-10 rounded-[2.4rem] bg-surface-container-high p-8 text-center shadow-inner shadow-primary/5">
          ...
          <p className="mx-auto mt-4 max-w-[18rem] leading-7 text-on-surface-variant">
            {t("但到底哪些人才有資格通過？下一步會看聖經如何說明人的回應。")}
          </p>
        ...
        <JourneyPager
          previous={{ to: '/journey/problem', label: t('人的問題') }}
          next={{ to: '/journey/response', label: t('人的回應') }}
        />
      </main>
    </>
  );
...
export function HumanResponseScreen() {
  ...
  return (
    <>
      <PageHeader title={t("人的回應")} backTo="/journey/bridge" />
      ...
      <main className="px-6 pb-36 pt-8">
        <section className="rounded-[2.35rem] bg-surface-container-low p-8 shadow-[0_22px_56px_rgba(40,53,28,0.1)]">
          ...
          <p className="mt-3 font-medium leading-7 text-secondary">
            {t("那些聽到福音、願意悔改歸回神身邊的人，只要信，就是相信並接受，就能得到耶穌的拯救，與神重建關係。")}
          </p>
        </section>
        ...
        <section className="mt-10">
          <h3 className="font-headline text-[1.8rem] text-primary">{t("何為「信」？")}</h3>
          <div className="mt-5 grid gap-4">
        ...
        <section className="relative mt-10 overflow-hidden rounded-[2.4rem] bg-primary p-8 text-white shadow-[0_28px_72px_rgba(40,53,28,0.22)]">
          ...
          <div className="relative">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-headline text-[2rem]">{t("出死入生")}</h3>
            </div>
            <img
            ...
            />
            <p className="mt-5 text-[1.08rem] leading-8 text-on-primary-container">
              {t("任何人若誠心相信接受耶穌基督的拯救，他便立刻得到這拯救，就是罪得赦免，已經出死入生，成為神的兒女，有永遠與神一起的新生命。")}
            </p>
            <ScriptureCard
              reference={t("約翰福音 5:24")}
              verse={t("那聽我話、又信差我來者的，就有永生，不至於定罪，是已經出死入生了。")}
              tone="dark"
              accent="soft"
              className="mt-8 bg-white/10"
            />
        ...
        <section className="mt-10 rounded-[2.4rem] bg-surface-container-high p-8 text-center shadow-inner shadow-primary/5">
          <h3 className="font-headline text-[2rem] text-primary">
            {tContent(customScreenTexts, 'bridge:decision-title') || t('輪到你了')}
          </h3>
          <p className="mx-auto mt-4 max-w-[18rem] leading-7 text-on-surface-variant">
            {tContent(customScreenTexts, 'bridge:decision-desc') || t('若你願意相信並接受耶穌基督的救贖，歸回神身邊，你要向神清楚表明你的決定。') || t('若你願意相信並接受耶穌基督的救贖，歸回神的身邊，你要向神清楚表明你的決定。')}
          </p>
          <div className="mt-8 rounded-[1.7rem] bg-surface-container-lowest p-5 text-left shadow-[0_16px_34px_rgba(40,53,28,0.06)]">
            <p className="font-body text-[11px] font-extrabold tracking-[0.2em] text-secondary">
              {tContent(customScreenTexts, 'salvation:prayer-title') || t('決志禱告：接受耶穌基督的拯救')}
            </p>
            <p className="mt-4 font-headline text-[1.05rem] leading-8 text-primary">
              {tContent(customScreenTexts, 'salvation:prayer-body') ||
                t('「神啊，我承認自己是一個有罪的人，違背了你。我知道你愛我，又相信你已藉著耶穌基督為我準備了救贖。我誠心接受耶穌基督為我的救主，求你照你所應許的，赦免我的罪，讓我重新成為你的兒女。又求你今後引導我的生命，讓你賜給我的新生命繼續成長。奉耶穌基督的名禱告，阿們。」')}
            </p>
          </div>
          <div className="mt-6 flex flex-col items-center gap-3">
            <p className="text-[11px] font-extrabold tracking-[0.22em] text-outline/70">
        ...
        <JourneyPager
          previous={{ to: '/journey/bridge', label: t('神的拯救') }}
          next={{ to: '/journey/salvation-assurance', label: t('得救的確據') }}
        />
      </main>
    </>
  );
